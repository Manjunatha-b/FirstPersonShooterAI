...
class Driver:
    def __init__(self):
        ...
        self.channel.set_configuration_parameters(width=640,height=360,time_scale=10)
        self.env.reset()
        ...
        self.dqn = DQN(77,len(self.act_dict),1024)
...
while(True):
    ...
    if(terminal):
        ...
        running_reward=0
        driver.dqn.epsilon = driver.dqn.epsilon+0.0002
    
    if(epcount%20==0):
        torch.save(driver.dqn.state_dict(),"./MLFiles/checkpoints/"+str(epcount)+"_DQN.pth")